...
class SnapshotPatrolService:
    ...
    def _tick(
        ...
        if result.get("has_camera_shift") or result.get("has_camera_tilt"):
            self._emit_alert(
                result,
    ...
    def _emit_alert(
        ...
        *,
        ...
        prefix = "camera_tilt" if is_tilt else "camera_shift"
        default_type = "09" if is_tilt else "08"
        label = "角度偏离" if is_tilt else "位置挪移"
