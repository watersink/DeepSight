...
class KalmanFilterXYWH(KalmanFilterXYAH):
    ...
    def project(self, mean, covariance, confidence=None) -> tuple:
        """
        Project state distribution to measurement space.
        ...
        Args:
            mean (ndarray): The state's mean vector (8 dimensional array).
            covariance (ndarray): The state's covariance matrix (8x8 dimensional).
            confidence (float, optional): Detection confidence for NSA-Kalman noise scaling.
    ...
    def update(self, mean, covariance, measurement, confidence=None) -> tuple:
        """
        Run Kalman filter correction step.
        ...
        Args:
            mean (ndarray): The predicted state's mean vector (8 dimensional).
            covariance (ndarray): The state's covariance matrix (8x8 dimensional).
            measurement (ndarray): The 4 dimensional measurement vector (x, y, w, h).
            confidence (float, optional): Detection confidence for NSA-Kalman noise scaling.
